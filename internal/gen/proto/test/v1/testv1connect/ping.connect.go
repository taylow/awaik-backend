...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/taylow/awaik-backend/internal/gen/proto/test/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PingServiceName = "test.v1.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/test.v1.PingService/Ping"
	// PingServicePingStreamProcedure is the fully-qualified name of the PingService's PingStream RPC.
	PingServicePingStreamProcedure = "/test.v1.PingService/PingStream"
	// PingServiceFailProcedure is the fully-qualified name of the PingService's Fail RPC.
	PingServiceFailProcedure = "/test.v1.PingService/Fail"
)

// PingServiceClient is a client for the test.v1.PingService service.
...
// NewPingServiceClient constructs a client for the test.v1.PingService service. By default, it uses
...
// Ping calls test.v1.PingService.Ping.
...
// PingStream calls test.v1.PingService.PingStream.
...
// Fail calls test.v1.PingService.Fail.
...
// PingServiceHandler is an implementation of the test.v1.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/test.v1.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("test.v1.PingService.Ping is not implemented"))
}
...
func (UnimplementedPingServiceHandler) PingStream(context.Context, *connect.BidiStream[v1.PingStreamRequest, v1.PingStreamResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("test.v1.PingService.PingStream is not implemented"))
}
...
func (UnimplementedPingServiceHandler) Fail(context.Context, *connect.Request[v1.FailRequest]) (*connect.Response[v1.FailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("test.v1.PingService.Fail is not implemented"))
}
